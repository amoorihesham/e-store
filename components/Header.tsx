        ...
        <div className="md:hidden flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Sheet>
              ...
              <SheetContent>
                ...
                <Form action="/search" className="space-y-2 mt-5">
                  <Input
                    placeholder="Search"
                    name="query"
          ...
          <ClerkLoaded>
            <div className="flex items-center gap-1">
              ...
              <SignedIn>
                <Link href={"/orders"} aria-label="go to orders page">
              ...
              <SignedOut>
                <SignInButton mode="modal" aria-label="sign in button">
                  <Button
                    variant="ghost"
                    className="px-2"
          ...
          <div className="hidden items-center gap-5 md:flex  justify-end">
            <ClerkLoaded>
              <div className="flex items-center gap-3 flex-1 justify-end">
                ...
                <SignedOut>
                  <SignInButton mode="modal" aria-label="sign out button">
                    <Button
                      variant="ghost"
