...
const CartPage = () => {
  return (
    <MaxWidthContainer className="py-6">
      ...
      <div className="flex items-stretch justify-between gap-x-10 mt-10">
        ...
        <div className="flex-1/2 max-w-sm border rounded-sm p-6 bg-foreground/10 sticky top-30 min-h-[calc(100dvh-(79px+120px))]">
