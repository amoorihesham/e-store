  ...
  return (
    <MaxWidthContainer className="py-8">
      <div className="flex items-stretch justify-between gap-x-10">
              ...
              >
                ...
                <div className="flex-1 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground text-lg font-thin mt-3">
                      productId: #{product.product?._id.slice(-10)}
                    </p>
                  </div>
                  <div>
                    <p className="font-bold text-2xl text-primary">
                      {formatPrice(product.product?.base_price!)}
                    </p>
        ...
        <div className="p-6 rounded-md bg-foreground/10 w-sm min-h-[calc(100dvh-(79px+60px))] sticky top-20">
          ...
          <div className="mt-4">
            <div>
              <div className="flex flex-col items-center">
                ...
                <span className="text-lg font-semibold uppercase mt-2 mb-1">
                  paid
                </span>
                <span className="text-muted-foreground text-sm font-light mb-2">
                  {formatDateTime(order?.orderDate!)}
                </span>
              </div>
              <div className="flex flex-col items-center">
