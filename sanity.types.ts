...
// Variable: GET_ORDER_QUERY
// Query: *[_type=='order' && orderNumber == $orderNumber][0]{    _id,    orderNumber,    status,    totalPrice,    orderDate,    products[]{      quantity,      product->{        _id,        name,        base_price,        image      }    }  }
export type GET_ORDER_QUERYResult = {
  _id: string;
